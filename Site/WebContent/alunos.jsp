					...
					<div>
						...
						<form action="acoes/alunoAcao.jsp">
							...
							<label>Sexo <br> <input type="radio" value="F"
								name="sexo" required>Feminino <input type="radio"
								value="M" name="sexo">Masculino
							...
							</label> <br> <label>Nome da Mãe <br> <input
							...
							<!-- Cadastrar Telefone -->
							<label>Telefone <br> <input type="text" id="name"
								class="phone-ddd-mask" name="telefone"
							...
							<label>Nome Responsável <br> <input type="text"
								name="responsavel" required>
							</label> <br> <label>Telefone Responsável <br> <input
								type="text" id="name" class="phone-ddd-mask"
								name="telResponsavel" placeholder="Ex.: (00) 0000-0000" required>
							</label> <label>Celular Responsável <br> <input type="text"
							...
							<input type="text" name="logradouro" placeholder="LOGRADOURO"
								...
								placeholder="Nº" required> <br> <br> <input
